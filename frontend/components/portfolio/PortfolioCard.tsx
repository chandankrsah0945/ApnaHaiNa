...
export default function PortfolioCard({ project }: PortfolioCardProps) {
  ...
  return (
    <article className="group relative overflow-hidden rounded-[2rem] border border-slate-800/90 bg-slate-950/70 shadow-[0_24px_60px_rgba(2,6,23,0.3)] backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:border-cyan-400/40 hover:shadow-[0_30px_80px_rgba(8,145,178,0.22)]">
      ...
      <div className="relative z-10 flex flex-col p-6 sm:p-7">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          {project.liveExternal ? (
            ...
            <a href={project.liveHref} className={liveButtonClassName}>
              <span>Live Project</span>
              <FaExternalLinkAlt aria-hidden="true" className="text-xs" />
            </a>
          )}
